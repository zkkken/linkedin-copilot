...
export const SECTION_CONFIGS: Record<SectionType, SectionConfig> = {
  ...
  recommendations: {
    ...
    description: '提炼已有推荐的关键亮点（不生成新推荐）',
    maxLength: 300,
    rows: 4,
    icon: '💬',
  },
